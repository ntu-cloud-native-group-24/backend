...
ALTER TABLE "store_meal_categories" ADD FOREIGN KEY ("store_id") REFERENCES "stores" ("id");

ALTER TABLE "meal_categories_assoc" ADD FOREIGN KEY ("meal_id") REFERENCES "meals" ("id");

ALTER TABLE "meal_categories_assoc" ADD FOREIGN KEY ("category_id") REFERENCES "store_meal_categories" ("id");

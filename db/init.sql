...
ALTER TABLE "store_categories" ADD FOREIGN KEY ("store_id") REFERENCES "stores" ("id");
...
ALTER TABLE "meal_assoc" ADD FOREIGN KEY ("category_id") REFERENCES "meal_categories" ("id");
